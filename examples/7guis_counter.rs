...
impl App {
    pub(crate) fn new() -> Self {
        ...
        let x = widget_manager.new_label("0");
        let y = widget_manager.new_label("Count");
...
impl Application for App {
    fn handle_user_event(&mut self, user_event: &UserEvent) {
        ...
        let widget_events = self.widget_manager.handle_user_event(user_event);
            ...
            match widget_event {
                WidgetEvent::Clicked(widget_id) => {
                    ...
                    if widget_id == self.id_counter_button {
                        ...
                        self.widget_manager
                            .handle_widget_command(&WidgetCommand::SetValue(
